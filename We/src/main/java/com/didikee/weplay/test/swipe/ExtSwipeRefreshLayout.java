package com.didikee.weplay.test.swipe;
...
public class ExtSwipeRefreshLayout extends ViewGroup {
    ...
    public ExtSwipeRefreshLayout(Context context) {
        this(context, null);
    }

    @SuppressWarnings("deprecation")
    public ExtSwipeRefreshLayout(Context context, AttributeSet attrs) {
        super(context, attrs);
